...
//
//    it should "extract fields" in {
//
//        implicit def testExtractor : Extractor.Aux[ Int, String, Int, String ] = new Extractor[ Int, String, Int ] {
//            override type Out = String
//
//            override def extract( from : Int, to : String, using : Int ) : Out = {
//                to + s" ${from + using}"
//            }
//        }
//
//        implicitly[ Extractor[ Int, String, Int ] ].extract( 1, "", 3 ) shouldBe " 4"
//
//        import Extractor._
//
//        implicitly[ Extractor[ Int, String, HNil ] ].extract( 1, "", HNil ) shouldBe ""
//
//        implicitly[ Extractor[ Int, String, Int :: Int :: Int :: HNil ] ].extract( 1, "", 2 :: 3 :: 4 :: HNil ) shouldBe " 3 4 5" //
//
//    }
//
...
//
//                override def extract( from : Map[ Int, String ], using : Int ) : Res = {
//                    from( using )
//                }
//            }
//        }
