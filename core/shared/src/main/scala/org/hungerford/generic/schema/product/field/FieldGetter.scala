...
object FieldGetter {
    ...
    given [ T, F, N <: FieldName, Field <: Field.OrLazy[ T, F, N ], RTail <: Tuple, RVHead, RVTail <: Tuple ] :
        FieldGetter.Aux[ N, Field *: RTail, RVHead *: RVTail, RVHead ] = {
        new FieldGetter[ N, Field *: RTail, RVHead *: RVTail ] {
            type Out = RVHead
