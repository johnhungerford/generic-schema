...
//
//
//case class ProductSchemaBuilder[ T, R <: Tuple, RV <: Tuple, AF, AFS, Tup ](
...
//
//    def addField[ F, NewR <: Tuple, NewRV <: Tuple, NewTup, S ](
//        fd : FieldDescription.Aux[ F, S ],
//    )(
//        implicit
//        prepR : Prepend.Aux[ R, FieldDescription.Aux[ F, S ] *: EmptyTuple, NewR ],
//        prepRV : Prepend.Aux[ RV, F *: EmptyTuple, NewRV ],
//        tup : Tupler.Aux[ NewRV, NewTup ],
//        rConstraint : CtxWrapTuplesConstraint[ FieldDescription, NewR, NewRV ]
...
//}
//
//case class ProductSchemaBuilderWithConstructor[ T, R <: Tuple, RV <: Tuple, AF, AFS, Tup ](
//    private[ product ] val desc : Option[ String ] = None,
//    private[ product ] val vals : Set[ Validator[ T ] ] = Set.empty[ Validator[ T ] ],
//    private[ product ] val aftSch : Schema.Aux[ AF, AFS ],
//    private[ product ] val fieldDescs : R,
...
//}
//
//case class ProductSchemaBuilderWithDeconstructor[ T, R <: Tuple, RV <: Tuple, AF, AFS, Tup ](
//    private[ product ] val desc : Option[ String ] = None,
//    private[ product ] val vals : Set[ Validator[ T ] ] = Set.empty[ Validator[ T ] ],
//    private[ product ] val aftSch : Schema.Aux[ AF, AFS ],
//    private[ product ] val fieldDescs : R,
...
//}
//
//case class BuildableProductSchemaBuilder[ T, R <: Tuple, RV <: Tuple, AF, AFS, Tup ](
//    private[ product ] val desc : Option[ String ] = None,
//    private[ product ] val vals : Set[ Validator[ T ] ] = Set.empty[ Validator[ T ] ],
//    private[ product ] val aftSch : Schema.Aux[ AF, AFS ],
//    private[ product ] val fieldDescs : R,
...
//}
//
//case class AdditionalFieldsBuilder[ T, R <: Tuple, RV <: Tuple, AF, Tup ](
//    private[ product ] val desc : Option[ String ] = None,
//    private[ product ] val vals : Set[ Validator[ T ] ] = Set.empty[ Validator[ T ] ],
//    private[ product ] val fieldDescs : R,
//)(
...
//    def from[ T, R <: Tuple, RV <: Tuple, AF, AFS, Tup ](
