...
import org.hungerford.generic.schema.utilities.{Align, MigrationAlign, ShapeMigration}

class AlignTest extends AnyFlatSpecLike with org.scalatest.matchers.should.Matchers {
	...
	it should "do nothing to empty tuples" in {
		...
		type RV2 = EmptyTuple
		type R2 = EmptyTuple
		val align = summon[Align[RV1, R1, Nothing, RV2, R2, Nothing]]
