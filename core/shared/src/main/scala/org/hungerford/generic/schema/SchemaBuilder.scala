...
//
//    def product : ProductSchemaBuilder[ T, EmptyTuple, EmptyTuple, Nothing, Unit, Unit ] =
//        ProductSchemaBuilder[ T, EmptyTuple, EmptyTuple, Nothing, Unit, Unit ](
//            desc,
//            vals,
//            NoSchema,
//            EmptyTuple,
//        )
//
//    def caseClass[ R <: Tuple, Rt <: Tuple, RVt <: Tuple, Tupt ](
//        implicit
