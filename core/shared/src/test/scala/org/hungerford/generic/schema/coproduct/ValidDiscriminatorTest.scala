...
//        Schema.derived[ P1 ]
//    }
//    val st1 = SubtypeCase[ Any, P1, Int, "d", 1, "subtype-1", sch1.Shape ]( "subtype-1", sch1, v => v, { case v : P1 => Some( v ); case _ => None }, 1 )
//
...
//        Schema.derived[ P2 ]
//    }
//    val st2 = SubtypeCase[ Any, P2, Int, "d", 2, "subtype-2", sch2.Shape ]( "subtype-2", sch2, v => v, { case v : P2 => Some( v ); case _ => None }, 2 )
//
...
//    }
//    val badSt2 = SubtypeCase[ Any, BadP2, Int, "e", 3, "subtype-2-bad",  badSch2.Shape ]( "subtype-2-bad", badSch2, v => v, { case v : BadP2 => Some( v ); case _ => None }, 3 )
//
...
//    }
//    val badSt3 = SubtypeCase[ Any, BadP3, String, "d", 4, "subtype-3-bad", badSch3.Shape ]( "subtype-3-bad", badSch3, v => v, { case v : BadP3 => Some( v ); case _ => None }, 4 )
//
