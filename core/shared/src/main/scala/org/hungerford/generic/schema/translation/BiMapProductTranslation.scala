...
//     inline def writerFromProductWithoutAF[ T, Rt <: Tuple, RVt <: Tuple ](
//         product : ProductShape[ T, Rt, RVt, Nothing, Unit ],
//     ) : T => MapVal = { ( value : T ) =>
//         val (fields, _) = product.deconstructor( value )

//         val buildMapWithFields =      
//     }
...
//        ( schema : Schema.Aux[ T, ProductShape[ T, Rt, RVt, Nothing, Unit ] ] ) => {
